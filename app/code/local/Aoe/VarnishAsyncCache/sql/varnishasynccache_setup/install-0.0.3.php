...
/**
 * Create table 'varnishasynccache/blacklist_url_pattern'
 */
$table = $installer->getConnection()
    ->newTable($installer->getTable('varnishasynccache/blacklist_url_pattern'))
    ...
    ->addIndex($installer->getIdxName('varnishasynccache/blacklist_url_pattern', array('pattern'),
