 ...
 */
class Aoe_VarnishAsyncCache_Block_Adminhtml_BlacklistUrlPattern_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
    /**
    ...
    public function __construct()
    {
        ...
        $this->setTitle(Mage::helper('varnishasynccache')->__('Blacklist url pattern'));
    }
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset('base_fieldset', array(
            'legend'    => Mage::helper('varnishasynccache')->__('Blacklist url pattern')
        ));

        $fieldset->addField('pattern', 'text', array(
            'label'     => Mage::helper('varnishasynccache')->__('Pattern'),
            'title'     => Mage::helper('varnishasynccache')->__('Pattern'),
